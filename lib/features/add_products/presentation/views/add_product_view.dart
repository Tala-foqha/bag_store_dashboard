...
class AddProductView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: BlocProvider(
          create: (context) =>  AddProductCubit(imagesRepo: ImagesRepoImpl(storageServices: SubabaseServices()), 
          productsRepo: ProductsRepoImpl(databaseServices: FirestoreServices())
